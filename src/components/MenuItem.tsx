...
export type MenuOptions = 'Edit' | 'Duplicate' | 'Delete' | 'Favorite' | 'Move' | 'Share' | 'Archive';
    ...
    <div className="py-1" onClick={onClick}>
      <Menu.Item>
        {({ active }) => (
          <a
            href="#"
            className={`flex items-center px-4 py-2 text-sm ${active ? 'bg-indigo-500 text-white' : 'text-gray-700'}`}
          >
