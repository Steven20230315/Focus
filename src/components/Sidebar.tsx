...
export default function Sidebar() {
  ...
  return (
    <div
      className={`sticky top-0 flex min-h-screen min-w-62.5 flex-col px-2 pt-4 ${!isSidebarOpen ? 'bg-gray-700' : 'border border-gray-500 bg-gray-600 shadow-xl shadow-black'}`}
    >
